...
type StateDB struct {
	...
	stateObjects        map[common.Address]*stateObject //mike 状态map
...
func (s *StateDB) AddBalance(addr common.Address, amount *big.Int) { //mike 矿工发奖励
...
func (s *StateDB) CreateAccount(addr common.Address) { //mike 创建一个合约账户
