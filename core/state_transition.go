...
func (st *StateTransition) TransitionDb() (*ExecutionResult, error) { //mike
	...
	if contractCreation { //mike 如果是创建合约
		ret, _, st.gas, vmerr = st.evm.Create(sender, st.data, st.gas, st.value) //mike 创建合约
	} else {
